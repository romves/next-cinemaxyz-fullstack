...
import { cn } from "@/common/config/utils";
...
>(({ className, closeHandler, ...props }, ref) => (
...
>(({ className, children, withClose, closeHandler, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay closeHandler={closeHandler} />
