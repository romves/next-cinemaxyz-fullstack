...
import SeatLayout from "@/shared/components/SeatLayout";
...
const BookDetail = ({ movie }: { movie: BookDetailProps }) => {
  ...
  return (
    <div className="flex flex-col items-center gap-2 text-sm lg:items-start lg:flex-row lg:justify-center">
      <SeatLayout
        screeningId={booking.screeningId}
